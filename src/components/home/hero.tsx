...
export const Hero = () => {
    return (
        <section className="min-h-screen relative flex flex-col justify-center overflow-hidden pt-20">
            ...
            <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-accent-blue/10 rounded-full blur-[120px] mix-blend-screen opacity-50" />
            ...
            <div className="max-w-7xl mx-auto px-6 w-full relative z-10 grid lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-8 flex flex-col items-start text-left">
                    {/* Status Badge */}
                    <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full border border-accent-blue/20 bg-accent-blue/5 backdrop-blur-md mb-8 hover:border-accent-blue/40 transition-colors cursor-default group">
                    ...
                    <h1 className="text-7xl md:text-9xl font-bold tracking-tighter leading-[0.9] mb-8">
                        ...
                        <span className="block text-accent-blue/90">
                            + GTM
                        </span>
                    </h1>

                    <p className="text-xl md:text-2xl text-muted-foreground font-light max-w-2xl leading-relaxed border-l-2 border-accent-blue/30 pl-6 my-8">
                        The bridge between <span className="text-foreground font-normal border-b border-accent-blue/30">user empathy</span> and <span className="text-foreground font-normal border-b border-accent-teal/30">business logic</span>.
                    </p>

                    <div className="flex flex-wrap gap-4 mt-4">
                        <a
                            href="#projects"
                            className="px-8 py-4 bg-foreground text-background font-bold text-lg rounded-none hover:bg-accent-blue hover:text-white transition-all transform hover:-translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(255,255,255,0.2)]"
                        >
                            EXPLORE WORK
                        </a>
                        <a
                            href="#contact"
                            className="px-8 py-4 border border-border text-foreground font-medium text-lg rounded-none hover:border-accent-blue hover:text-accent-blue transition-all"
                        >
                            CONTACT ME
                        </a>
                    </div>
                ...
                <div className="lg:col-span-4 relative hidden lg:block h-[600px]">
                    ...
                    <div className="absolute top-10 right-0 w-64 h-80 bg-black/40 border border-white/10 backdrop-blur-md rounded-none rotate-6 z-10 p-6 flex flex-col hover:rotate-2 hover:scale-105 transition-all duration-500 hover:border-accent-blue/30">
                        ...
                        <div className="flex items-end justify-between h-40 gap-2 mb-4">
                            <div className="w-full bg-white/5 h-[30%] relative group-hover:bg-accent-blue/20 transition-colors" />
                            <div className="w-full bg-white/5 h-[45%] relative group-hover:bg-accent-blue/30 transition-colors" />
                            <div className="w-full bg-white/5 h-[35%] relative group-hover:bg-accent-blue/20 transition-colors" />
                            <div className="w-full bg-white/5 h-[60%] relative group-hover:bg-accent-blue/40 transition-colors" />
                            <div className="w-full bg-white/5 h-[80%] relative group-hover:bg-accent-blue/60 transition-colors" />
                        </div>

                        <div className="mt-auto pt-4 border-t border-white/5 flex gap-2">
                            <div className="w-2 h-2 bg-accent-blue rounded-none" />
                    ...
                    {/* Decorative Lines */}
                    <div className="absolute top-1/2 right-10 w-px h-32 bg-gradient-to-b from-transparent via-accent-blue to-transparent z-0" />
